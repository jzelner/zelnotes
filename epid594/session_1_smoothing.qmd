...
In our first Zoom session of this course, we will spend some time discussing and thinkikng about the concept of spatial *smoothing* and why it is such a central idea in spatial analysis and medical geography. Specifically, we will spend our time on the following activities:
...
6. A [hands-on tutorial](https://sph-umich.shinyapps.io/smoothing/)about way smoothers are employed to make estimates and identify hotspots.(~25m)
