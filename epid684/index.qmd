...
|Date|Topic|
|----|:----|
|`r next_date()`| Space meets place |
|`r next_date()`| Conceptual intro to multi-level regression |

## Destination Project Progress

|Date|Topic|
|----|:----|
|`r next_date()`| In-class project workshop |
| `r next_date()` | Destination lightning updates | 

## Mini-module: Fallacies!
...
**Winter break - no class!** `r next_date()` & `r next_date()`  
