...
> [!IMPORTANT] The primary factors that would result in a downward revision of a student's self-assessed grade are 1) chronic, unexplained lateness in turning in assignments or not completing assignments, 2) instances of academic dishonesty.
...
> [!WARNING] However, on days when students are presenting and giving/receiving feedback, attendance or an excused absence is required and unexplained/excused absence may result in a downward revision of your final grade. This requirement reflects a recognition that on these days of class, individual attendance impacts all course members. 
