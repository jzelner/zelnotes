---
pagetitle: "Modifiable areal unit problem"
author: 
  - name: Jon Zelner
format: 
    revealjs:
...
# <span style="color:white">It came from the MAUP!</span> {background-image="../images/creature_from_the_black_lagoon_franchise_retrospective.jpg"}
