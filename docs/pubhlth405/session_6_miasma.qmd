...
- If time: pathogen project work time
...
## Snow built his understanding with information from <span class="alert">multiple sources</span>
...
![Go to this [Miro board](https://miro.com/app/board/uXjVPWBomlk=/?share_link_id=219375095326) to get started on your group's representation of Snow's multi-scale connections](../images/20220916111609.png)  


## Some questions to chew over in your groups
