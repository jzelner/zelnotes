...
format: 
    revealjs:
        ...
        extract-media: no_equal_opportunity_infectors_bdsi_files/images
---
...
<div class="paddeddiv">
  <p style="font-size:0.5em; text-align: left;">
    2022 Big Data Summer Institute
      <br><br>
      Jon Zelner  
      `jzelner@umich.edu`  
...
- Discuss why spatial epidemiologists and epidemiological modelers have largely ignored inequality in our approach to infectious disease.
...
- Highlight why developing mathematical and spatial models that reflect a diversity of understandings about <span class="alert">how transmission systems work</span> is essential for equitable preparedness and population health.
- <span class="alert">Test drive</span> a model that joins socio-spatial factors with infectious disease dynamics.
...
## What are we talking about when we talk about <span class="alert">modeling</span>?

- Represent <span class="alert">explicit hypotheses</span> about transmission mechanisms.
...
- Includes transmission models as well as spatial and network representations.
...
## COVID-19 provides an opportunity to reflect on the goals of epidemiological modeling {.quote}
