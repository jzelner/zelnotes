...
<div class="itemr" id="footerDiv"><img class="footerImg" src="../../assets/epibayeslogo.png"><img class="footerImg" src="../images/Epid_external_horiz.png"></div>

# Goals

>- Discuss why epidemiological models (and modelers) have had a blind spot for inequality in our approach to pandemic preparedness.
