...
<a href="https://pubmed.ncbi.nlm.nih.gov/27872284/">
<img src="../images/grantz_disparities_1918.png">
</a>

# The mechanisms of inequity were quickly identified, but our models weren't ready for them {.quote}

<img src="../images/racial_capitalism_mcclure.png">

# COVID-19 provides an opportunity to reflect on who and what transmission models are for
...
From Zelner et al. "There are no equal opportunity infectors." PLOS Computational Biology, *In Press* (Preprint available [here](https://arxiv.org/abs/2109.00580).)
...
# These <span class="alert">equity-oriented</span> models let us ask crucial questions about the causes of disparity

<img src="../images/nande_evictions_covid_transmission.png">
