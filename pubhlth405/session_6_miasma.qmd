...
![What phase of Rosenberg's outbreak trajectory would this put us in?](../images/20220919114028.png)  
...
## Making use of evidence across <span class="alert">scales</span> is a central theme of Snow's analysis of the 1854 Cholera outbreak.
...
## What are the elements of a <span class="alert">transmission system</span>?
...
## Your turn to make connections <span class="alert">across scales</span>

![We will use this [Miro board](https://miro.com/app/board/uXjVPWBomlk=/?share_link_id=219375095326) to get started on your group's representation of Snow's multi-scale connections](../images/20220916111609.png)  


## First: Discuss how Snow built his understanding with information from <span class="alert">multiple sources</span> (~10m)
...
4. How did Snow start to use evidence at different scales to push back against the miasmatists?
